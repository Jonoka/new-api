...
func isOpenAIVideoRequestURI(requestURI string) bool {
	return strings.HasPrefix(requestURI, "/v1/videos/") ||
		strings.HasPrefix(requestURI, "/canvas/v1/videos/") ||
		strings.HasPrefix(requestURI, "/v1/video/generations/") ||
		strings.HasPrefix(requestURI, "/canvas/v1/video/generations/")
}

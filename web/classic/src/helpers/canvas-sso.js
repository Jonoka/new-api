...
export function safeCanvasDestination(value) {
...
export function buildCanvasSSOLaunchUrl(origin, group, next = '/', returned = false) {
...
function canvasReturnPath(value) {
...
export function rememberCanvasReturn(value) {
...
export function consumeCanvasReturn() {
  try {
